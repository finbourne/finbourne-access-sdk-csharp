...
namespace Finbourne.Access.Sdk.Model
{
    ...
    public partial class PolicyCreationRequest :  IEquatable<PolicyCreationRequest>
    {
        ...
        public PolicyCreationRequest(string code = default(string), string description = default(string), List<string> applications = default(List<string>), Grant grant = default(Grant), List<SelectorDefinition> selectors = default(List<SelectorDefinition>), List<ForSpec> _for = default(List<ForSpec>), List<IfExpression> _if = default(List<IfExpression>), WhenSpec when = default(WhenSpec), HowSpec how = default(HowSpec))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for PolicyCreationRequest and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (grant == null)
            {
                throw new InvalidDataException("grant is a required property for PolicyCreationRequest and cannot be null");
            }
            else
            {
                this.Grant = grant;
            ...
            if (selectors == null)
            {
                throw new InvalidDataException("selectors is a required property for PolicyCreationRequest and cannot be null");
            }
            else
            {
            ...
            if (when == null)
            {
                throw new InvalidDataException("when is a required property for PolicyCreationRequest and cannot be null");
            }
            else
            {
                this.When = when;
