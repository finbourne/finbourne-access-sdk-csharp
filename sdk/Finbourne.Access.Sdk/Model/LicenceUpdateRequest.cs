...
namespace Finbourne.Access.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LicenceUpdateRequest :  IEquatable<LicenceUpdateRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LicenceUpdateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LicenceUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LicenceUpdateRequest" /> class.
        /// </summary>
        ...
        public LicenceUpdateRequest(string description = default(string), List<string> applications = default(List<string>), List<LicenceSelectorDefinition> selectors = default(List<LicenceSelectorDefinition>), WhenSpec when = default(WhenSpec), List<ForSpec> _for = default(List<ForSpec>), HowSpec how = default(HowSpec), List<IfExpression> _if = default(List<IfExpression>))
        {
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for LicenceUpdateRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applications is a required property for LicenceUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (selectors == null)
            {
                throw new InvalidDataException("selectors is a required property for LicenceUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (when == null)
            {
                throw new InvalidDataException("when is a required property for LicenceUpdateRequest and cannot be null");
            }
            else
            {
                this.When = when;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LicenceUpdateRequest {\n");
        ...
        {
            return this.Equals(input as LicenceUpdateRequest);
        }

        /// <summary>
        /// Returns true if LicenceUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LicenceUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LicenceUpdateRequest input)
        {
            if (input == null)
                return false;
