...
namespace Finbourne.Access.Sdk.Model
{
    ...
    public partial class IfIdentityClaimExpression :  IEquatable<IfIdentityClaimExpression>
    {
        ...
        public IfIdentityClaimExpression(string claimType = default(string), string claimValueType = default(string), string claimIssuer = default(string), string claimOriginalIssuer = default(string), TextOperator _operator = default(TextOperator), string value = default(string))
        {
            ...
            if (claimType == null)
            {
                throw new InvalidDataException("claimType is a required property for IfIdentityClaimExpression and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("claimValueType is a required property for IfIdentityClaimExpression and cannot be null");
            }
            else
            {
            ...
            if (_operator == null)
            {
                throw new InvalidDataException("_operator is a required property for IfIdentityClaimExpression and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="claimValueType", EmitDefaultValue=false)]
