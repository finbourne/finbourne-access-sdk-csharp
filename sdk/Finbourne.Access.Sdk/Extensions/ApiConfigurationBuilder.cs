    ...
    public class ApiConfigurationBuilder
    {
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-ACCESS_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-access_api_url"),
