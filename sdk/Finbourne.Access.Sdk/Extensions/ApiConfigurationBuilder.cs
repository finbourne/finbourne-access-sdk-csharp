...
using System.IO;
using System.Linq;
using SdkConfiguration = Finbourne.Access.Sdk.Client.Configuration;
...
namespace Finbourne.Access.Sdk.Extensions
{
    ...
    public class ApiConfigurationBuilder
    {
        private static readonly Dictionary<string, string> ConfigNamesToEnvVariables = new Dictionary<string, string>()
            {
                ...
                { nameof(ApiConfiguration.BaseUrl), "FBN_ACCESS_URL" },
        ...
        private static readonly Dictionary<string, string> ConfigNamesToSecrets = new Dictionary<string, string>()
        {
            ...
            { nameof(ApiConfiguration.BaseUrl), "accessUrl" },
        ...
        private static ApiConfiguration BuildFromEnvironmentVariables(ConfigurationOptions? opts)
        {
            ...
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_ACCESS_URL") ??
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE-ACCESS_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne-access_api_url") ?? 
                          Environment.GetEnvironmentVariable("FBN_FINBOURNE_ACCESS_API_URL") ?? 
                          Environment.GetEnvironmentVariable("fbn_finbourne_access_api_url"),
